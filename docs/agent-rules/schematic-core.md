...
Update docs in the **same PR** as code. See AGENTS.md "Documentation maintenance" for the full table.

- **`docs/status.md`** — always when implementation changes
- **`AGENTS.md` + `docs/agent-rules/`** — when philosophy, practices, or agent workflow changes
- **`docs/plan.md`, `architecture.md`, `handlers.md`, `README.md`** — when your change affects what they describe
- **Do not** mark roadmap complete without code + status.md
- **Do not** document unimplemented features as shipped

## Before claiming done

- Update `docs/status.md` with what is actually implemented
- Update other affected docs (see above)
